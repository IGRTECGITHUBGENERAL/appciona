...
class SolicitarActualzacionPage extends StatefulWidget {
  final bool isEditing;

  final Cita? citasInfo;

  const SolicitarActualzacionPage({
    Key? key,
  ...
  @override
  State<SolicitarActualzacionPage> createState() => _SolicitaActualzacionCitaPageState();
}



class _SolicitaActualzacionCitaPageState extends State<SolicitarActualzacionPage> {
...
// Step 2.
                ...
                Text(
                  'Solo ser permite cambiar de hora y motivo',
